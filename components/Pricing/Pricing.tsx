  ...
  return (
    <div className=" bg-stone-900 ">
      <Container className="py-12">
        ...
        <div className="flex w-full snap-x gap-5 overflow-x-auto">
          {pricePackages.map((pricePackage) => (
            <div
              className="relative mb-4 flex w-80 shrink-0 scroll-ml-6 flex-col"
            ...
            >
              ...
              <div className="flex-grow bg-slate-50 px-6 pt-6 pb-8 sm:p-10 sm:pt-6">
                <ul>
